...
var Asteroid = /** @class */ (function (_super) {
    ...
    function Asteroid(x, y, velX, velY, exists, size) {
    ...
    Asteroid.prototype.draw = function () {
        ctx.beginPath();
        ctx.drawImage(asteroid.image, this.x - asteroid.image.width / 2, this.y - asteroid.image.height / 2, this.size, this.size);
    };
    ;
...
var Ship = /** @class */ (function (_super) {
    ...
    function Ship(x, y) {
        var _this_1 = _super.call(this, x, y, 4, 4, true) || this;
        _this_1.size = 30;
        return _this_1;
    }
    ;
...
while (asteroids.length < 5) {
    ...
    var ast = new Asteroid(random(0 + size, width - size), random(0 + size, height - size), random(-7, 7), random(-7, 7), true, size);
    asteroids.push(ast);
}
var player = new Ship(random(0 + 30, width - 30), random(0 + 30, height - 30));
player.setControls();
